...
<div class="login-page">
        <div class="form">
            <form class="login-form " action="" method="" >
                <h2 align="center">Authorised Book Successfully</h2>
                ...
                <button><a href="authorisebooks.jsp">Authorised</a><br>
                </button>
                
                <button><a href="AdminHome.jsp">Redirect to Admin home page
                </button>
