...
<header role="banner">
  ...
  <ul class="utilities">
    <br>
    <li class="users"><a href="AdminHome.jsp">My Account</a></li>
...
<nav role='navigation'>
  <ul class="main">
    <li class="dashboard"><a href="authorisebooks.jsp">Authorize new books</a></li>
    <li class="users"><a href="authoriseusers.jsp">Authorize new users</a></li>
    <li class="users"><a href="viewPurchase.jsp">View Purchase History</a></li>
    <li class="comments"><a href="viewAllSubscription.jsp">View Subscription</a></li>
    <li class="comments"><a href="removeusers.jsp">Remover Users</a></li>
    <li class="comments"><a href="RemoveBooks.jsp">Remove Books</a></li>
